<?php
	echo form_open(base_url("carrinho/finalizar_compra")) .
		...
		"Pagar com cartão: " . form_radio(array('name'=>'tipo_pagamento', 'value'=>'cartao',
...
$(document).ready(function() {
	$("input[name='tipo-pagamento']").click(function() {
		if($("input[name='tipo-pagamento']:checked").val()=='boleto') {
			$('#dados_cartao').hide();
		} else {
			$('#dados_cartao').show();
		}
